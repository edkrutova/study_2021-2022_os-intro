...
![Проверка](pics11/Screenshot_14.jpg){ #fig:004 width=70% }

## Задание 2 (рис. [-@fig:005]-[-@fig:009])

![Создание файла и вызов редактора](pics11/Screenshot_1.jpg){ #fig:005 width=70% }

![Текст программы на C заданию 2](pics11/Screenshot_2.jpg){ #fig:006 width=70% }

![Создание файла и вызов редактора](pics11/Screenshot_3.jpg){ #fig:007 width=70% }

![Текст командного файла к заданию 2](pics11/Screenshot_4.jpg){ #fig:008 width=70% }

![Создание исполняемого файла и проверка](pics11/Screenshot_5.jpg){ #fig:009 width=70% }

## Задание 3 (рис. [-@fig:010]-[-@fig:012])

![Создание файла и вызов редактора](pics11/Screenshot_6.1.jpg){ #fig:010 width=70% }

![Текст командного файла к заданию 3](pics11/Screenshot_6.jpg){ #fig:011 width=70% }

![Создание исполняемого файла и проверка](pics11/Screenshot_7.jpg){ #fig:012 width=70% }

## Задание 4 (рис. [-@fig:013]-[-@fig:015])

![Просмотр содержимого каталога](pics11/Screenshot_8.jpg){ #fig:013 width=70% }

![Текст командного файла к заданию 4](pics11/Screenshot_9.jpg){ #fig:014 width=70% }

![Ппроверка](pics11/Screenshot_10.jpg){ #fig:015 width=70% }
