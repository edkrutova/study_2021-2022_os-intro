...
Для начала необходимо было создать файлы, которые будут содержать коды программ (рис. [-@fig:001]):

![Создание файлов](pics14/Screenshot_1.jpg){ #fig:001 width=70% }

Далее я написала программы, аналогичные программам из примеров. Изменённые коды (рис. [-@fig:002]-[-@fig:004]):

![Код файла client.c](pics14/Screenshot_2.jpg){ #fig:002 width=70% }

![Код файла server.c](pics14/Screenshot_4.jpg){ #fig:003 width=70% }

![Код файла common.h](pics14/Screenshot_3.jpg){ #fig:004 width=70% }
...
Файл Makefile остался без изменений (рис. [-@fig:005]):

![Код файла Makefile](pics14/Screenshot_5.jpg){ #fig:005 width=70% }

Используя команду «make all», я скомпилировала необходимые файлы (рис. [-@fig:007]):

![Компиляция](pics14/Screenshot_6.jpg){ #fig:006 width=70% }

Проверка выполнения (рис. [-@fig:007]):

![Запущен сервер и два клиента](pics14/Screenshot_7.jpg){ #fig:007 width=70% }
